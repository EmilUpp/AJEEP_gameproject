...
public class sun : MonoBehaviour
{
    ...
    */
    private int generateEmittingTemperature()
    {
        ...
        const double minimumTemperature = 2000.0; //the minimum temperature for a star, also decides the maxiumum temperature
        ...
        float randMin = Convert.ToSingle(1.0 / (standardDeviation * Math.Sqrt(2 * Math.PI)) * Math.Exp(Math.Pow((minimumTemperature-averageTemperature) / standardDeviation, 2)));
